...
def identification(identification_choices):
    ...
    if identification_choices in ["Rebirth","rebirth","重生"]:
        ...
        Main.martial_arts.extend(["Realm Splitting Sword Art","World Grasping Formation Manual","Alchemy God's Inheritence","Diamond Body Technique","Ethereal Step Technique"])
    ...
    if identification_choices in ["Nobility","nobility","高貴"]:
        ...
        Main.martial_arts.extend(["Everlasting Sword Art","World Flow Breathing Technique"])
    ...
    if identification_choices in ["Alone","alone","孤"]:
        ...
        if transmigrator.lower() == "han jue":
            ...
            Main.traits.extend("all")
            Main.martial_arts.extend(["Perfection Sword Art", "Perfection Spear Art", "Perfection Fist Art", "Perfection Staff Art", "Origin Alchemy Technique", "Origin Formation Technique", "Origin Step Technique", "Origin Body Technique"])
...
def Body_Tempering_Arts(weapon_path_selection):
    ...
    if body_tempering_art_choice in ["other","Other"]:
        ...
        if body_confirmation[0] == "y":
            ...
            Main.martial_arts.append("Yoga Exercises for Eighty Year Olds to Strengthen Joints and Hip Mobility")
        ...
        if body_confirmation[0] == "n":
            ...
            print("5)Undying Warrior Body Technique")
            body_tempering_art_choice = input()
            Main.martial_arts.append(body_tempering_art_choice)
            First_Weapon(weapon_path_selection)
    else:
        Main.martial_arts.append(body_tempering_art_choice)
        First_Weapon(weapon_path_selection)
...
def Breathing_Arts(weapon_path_selection):
    ...
    if weapon_path_selection.lower() == "sword":
        ...
        Main.martial_arts.append(breathing_technique_choice)
    if weapon_path_selection.lower() == "bow":
